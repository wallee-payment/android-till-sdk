...
### Changed
- **Deprecation of PrimaryApplication configuration**: The existing `PrimaryApplication` setting in the Terminal Software Manager has been deprecated. Developers should migrate to using the `StartupApplication` parameter.
...
- The kiosk mode, previously defined via Android Till SDK manifest, will be
deprecated. Integrators should migrate to the new `StartupApplication`
method for managing app startup behavior.
